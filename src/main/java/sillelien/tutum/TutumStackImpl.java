 ...
 */
public class TutumStackImpl extends VarBackedTutumObject implements TutumStack {





    public TutumStackImpl(var json) {
    ...
    public List<TutumService> services() {
        return json.$("services").$list().stream().map(TutumServiceImpl::new).collect(Collectors.toList());
    }
